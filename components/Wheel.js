  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      >
        ...
        {/* center disc (static text, doesn’t rotate) */}
      ...
      {/* Result card */}
      {selectedSlot && (
        <div className="mt-1 w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl px-4 py-3 text-sm text-gray-200 shadow-[0_18px_45px_rgba(0,0,0,0.75)]">
