  ...
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-start pt-24 pb-32">
      ...
      <section className="text-center mb-10 px-4">
        <div className="mx-auto mb-4 inline-block rounded-full bg-white/5 px-4 py-1 text-xs tracking-wider text-purple-300 border border-white/10">
          ● NEW · SLOT WHEEL
        </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-14 px-4 max-w-3xl w-full">
        <div className="flex-1 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 shadow-lg">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            Every spin pulls a truly random slot. No weighting, no boosting — just a clean picker.
          </p>
        </div>
